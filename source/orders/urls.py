...
from orders.api_views import OrderList, OrderCreate, OrderDeleteApiView
from orders.views import OrderCreateView, order_list, OrderDeleteView, order_update, revenue_view
