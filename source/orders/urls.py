...
from orders.api_views import OrderList, OrderCreate, OrderDeleteApiView, OrderUpdateApiView, RevenueApiView
...
urlpatterns = [
    ...
    path('api/revenue/', RevenueApiView.as_view(), name='api_revenue'),
]
